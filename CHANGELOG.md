...
- [#23](https://github.com/interline-io/tlv2-auth/pull/23) [`831c2a6`](https://github.com/interline-io/tlv2-auth/commit/831c2a6d533fe1c6b3e25160975917e71c4fe790) Thanks [@irees](https://github.com/irees)! - Fix authenticated proxy requests being rejected by the backend with `token is malformed: token contains an invalid number of segments` (HTTP 401).
